    ...
    $.post("../index.php", cmd, function(dataDB){
        ...
        if(dataDB.status== false){
            ...
            contentStr= contentStr.replace(videoRe, function(word){ // 加上影片連結
                return "<a href= \"" + word.substring(2, word.length - 1) + "\" target= \"_blank\"><span class='glyphicon glyphicon-facetime-video'></span> Videos</a><br/>"+ // 可點擊的連結
                "<iframe width=\"360\" height= \"203\" src=\"h"+ word.substring(3, word.length- 1)+ 
            ...
            if(article.video)
                contentStr+= "<iframe   width='580' height='500' src= \""+ article.video+ "\"></iframe>";
            if(article.hashTag){
                contentStr+= "<br/>";
